...
# User.create({first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, username: "user3", password: "password", password_confirmation: "password"})
# User.create({first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, username: "user4", password: "password", password_confirmation: "password"})
